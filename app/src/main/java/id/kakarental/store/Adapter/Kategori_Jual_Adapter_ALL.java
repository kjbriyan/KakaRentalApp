...
public class Kategori_Jual_Adapter_ALL extends RecyclerView.Adapter<Kategori_Jual_Adapter_ALL.ViewHolder> {

    private static final String TAG = "Dasboard_Adapter";
    private static final String PRODUK_EXTRA_INTENT = "produk";

    private Context context;
    private List<BeliItemKategori> item;


    public Kategori_Jual_Adapter_ALL(Context context, List<BeliItemKategori> item) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View v, final Context context) {
            super(v);
        ...
        public void bindData(BeliItemKategori i) {
            ...
            status.setText("BARANG TERSEDIA");
