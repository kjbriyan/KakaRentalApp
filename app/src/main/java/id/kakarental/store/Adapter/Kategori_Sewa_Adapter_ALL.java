...
public class Kategori_Sewa_Adapter_ALL extends RecyclerView.Adapter<Kategori_Sewa_Adapter_ALL.ViewHolder> {

    private static final String TAG = "Dasboard_Adapter";
    private static final String PRODUK_EXTRA_INTENT = "produk";

    private Context context;
    private List<SewaItemKategori> item;


    public Kategori_Sewa_Adapter_ALL(Context context, List<SewaItemKategori> item) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(SewaItemKategori i) {
